...
export default function OpportunityStages() {
    ...
    const applyFilters = (status = selectedStatus, search = searchTerm) => {
        router.get(
            route('opportunity-stages.index'),
            {
                page: 1,
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        if (formMode === 'create') {
            const toastId = toast.loading(translate('Creating opportunity stage...'));
            ...
            const toastId = toast.loading(translate('Updating opportunity stage...'));
    ...
    const handleDeleteConfirm = () => {
        const toastId = toast.loading(translate('Deleting opportunity stage...'));
    ...
    const handleToggleStatus = (item: any) => {
        ...
        router.put(
            route('opportunity-stages.toggle-status', item.id),
            {},
            {
                onSuccess: () => {
                    toast.dismiss(toastId);
