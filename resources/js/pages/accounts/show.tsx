        ...
        <Card className="shadow-sm">
          ...
          {showStream && (
            <CardContent className="p-0">
              {/* Add Comment Form */}
              {hasPermission(permissions, 'create-accounts') && <div className="sticky top-0 bg-white z-10 p-6 pb-6 border-b">
                                ...
                                <div>
                                  {editingComment === activity.id ? (
                                    ...
                                    <div className="flex items-start justify-between">
                                      ...
                                      {((activity.user_id === auth?.user?.id ) && hasPermission(permissions, 'edit-accounts') )&& (
                                        <Button
                                          size="sm"
                                          variant="ghost"
