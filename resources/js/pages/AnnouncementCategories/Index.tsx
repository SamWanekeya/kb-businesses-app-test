...
export default function AnnouncementCategories() {
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        setFormErrors({});
        if (formMode === 'create') {
            const toastId = toast.loading(translate('Creating announcement category...'));
            ...
            const toastId = toast.loading(translate('Updating announcement category...'));
    ...
    const handleDeleteConfirm = () => {
        const toastId = toast.loading(translate('Deleting announcement category...'));
