                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-lg font-bold leading-tight">{getCaseTypeLabel(caseData.case_type)}</h3>
                                </div>
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-lg font-bold leading-tight">{window.appSettings?.formatDateTime(caseData.created_at, false) || new Date(caseData.created_at).toLocaleDateString()}</h3>
                                </div>
                            ...
                            {caseData.account && (
                                <div className="p-6 bg-green-50 rounded-xl border border-green-200 hover:shadow-md transition-shadow">
                                    ...
                                    {hasPermission(permissions, 'view-accounts') ? (
                                        ...
                                        <p className="text-sm font-medium text-green-700">{caseData.account.name}</p>
                                    )}
                                </div>
                            )}
                            ...
                            {caseData.contact && (
                                <div className="p-6 bg-blue-50 rounded-xl border border-blue-200 hover:shadow-md transition-shadow">
                                    ...
                                    {hasPermission(permissions, 'view-contacts') ? (
                                        ...
                                        <p className="text-sm font-medium text-blue-700">{caseData.contact.name}</p>
                                    )}
                                </div>
                            )}
                        </div>
