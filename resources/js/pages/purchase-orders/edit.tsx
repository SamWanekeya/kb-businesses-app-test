...
export default function PurchaseOrderEdit() {
    ...
    const { data, setData, setError, clearErrors, put, processing, errors } = useForm({
        ...
        sales_order_id: String(purchaseOrder.sales_order_id || ''),
        account_id: String(purchaseOrder.account_id || ''),
        billing_contact_id: String(purchaseOrder.billing_contact_id || ''),
        shipping_contact_id: String(purchaseOrder.shipping_contact_id || ''),
        status: purchaseOrder.status || 'draft',
        order_date: purchaseOrder.order_date ? purchaseOrder.order_date.substring(0, 10) : '',
        expected_delivery_date: purchaseOrder.expected_delivery_date ? purchaseOrder.expected_delivery_date.substring(0, 10) : '',
        assigned_to: String(purchaseOrder.assigned_to || ''),
        ...
        products: (purchaseOrder.products || []).map((p: any, i: number) => ({
            id: Date.now() + i,
