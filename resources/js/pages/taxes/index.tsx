...
export default function Taxes() {
    ...
    return (
        <PageTemplate title={t('Taxes')} url="/taxes" breadcrumbs={breadcrumbs} noPadding>
                            ...
                            <>
                                ...
                                {taxes?.total > (taxes?.per_page || 10) && (
                                    <div className="border-t border-gray-200 dark:border-gray-700">
                                        <Pagination from={taxes?.from || 0} to={taxes?.to || 0} total={taxes?.total || 0} links={taxes?.links} entityName={t('taxes')} onPageChange={(url) => router.get(url, {}, { preserveState: true, preserveScroll: true })} />
                                    </div>
                                )}
                            </>
                        ) : (
