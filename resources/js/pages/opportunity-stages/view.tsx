...
import { TrendingUp, Palette, Lock, FileText, Percent } from 'lucide-react';
        ...
        <DialogContent className="max-w-xl max-h-[90vh] overflow-y-auto p-0" onOpenAutoFocus={(e) => e.preventDefault()}>
            <DialogHeader className="px-6 pt-6 pb-4 border-b">
                <div className="flex items-center gap-3">
                    ...
                    <DialogTitle className="text-xl font-semibold">{t('Opportunity Stage Details')}</DialogTitle>
                </div>
            </DialogHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="mt-1 flex items-center gap-2">
                            ...
                            />
                            <p className="text-sm font-medium text-gray-900 dark:text-white font-mono">{record.color || '-'}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-gray-900 dark:text-white">
                            {record.probability !== undefined ? `${record.probability}%` : '-'}
                        </p>
                    </div>
                    <div>
                        <label className="text-sm font-medium text-gray-500 flex items-center gap-2">
