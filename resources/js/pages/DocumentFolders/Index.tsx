...
export default function DocumentFolders() {
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        if (formMode === 'create') {
            ...
            const toastId = toast.loading(translate('Updating document folder...'));
    ...
    const handleDeleteConfirm = () => {
        const toastId = toast.loading(translate('Deleting document folder...'));
                        ...
                        <form autoComplete="off" onSubmit={handleFormSubmit} className="space-y-4 p-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => {
                                        setFormData({ ...formData, parent_folder_id: value });
                                    }}
                                    disabled={!canCreate && !canEdit}
                                >
