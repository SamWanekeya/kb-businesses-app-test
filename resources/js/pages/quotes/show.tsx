      ...
      <div className="mx-auto space-y-6">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-lg font-bold leading-none">{formatCurrency(quote.total_amount)}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-lg font-bold leading-none">{quote.products?.length || 0}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-lg font-bold leading-tight">{window.appSettings?.formatDateTime(quote.valid_until, false) || '-'}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-lg font-bold leading-tight">{window.appSettings?.formatDateTime(quote.created_at, false) || new Date(quote.created_at).toLocaleDateString()}</h3>
                </div>
                ...
                <div className="p-6 bg-green-50 rounded-xl border border-green-200 hover:shadow-md hover:bg-green-50/80 hover:border-green-300 transition-all cursor-pointer">
                  ...
                  {hasPermission(permissions, 'view-accounts') ? (
                    <Link
                      ...
                      className="text-base font-medium text-green-700 underline-offset-2 hover:underline" style={{ color: '#15803d' }}>
                      {quote.account.name}
                    </Link>
                  ) : (
                ...
                <div className="p-6 bg-purple-50 rounded-xl border border-purple-200 hover:shadow-md hover:bg-purple-50/80 hover:border-purple-300 transition-all cursor-pointer">
                  ...
                  {hasPermission(permissions, 'view-contacts') ? (
                    <Link
                      ...
                      className="text-base font-medium text-purple-700 underline-offset-2 hover:underline" style={{ color: '#7e22ce' }}>
                      {quote.contact.name}
                    </Link>
                  ) : (
                ...
                <div className="p-6 bg-orange-50 rounded-xl border border-orange-200 hover:shadow-md hover:bg-orange-50/80 hover:border-orange-300 transition-all cursor-pointer">
                  ...
                  {hasPermission(permissions, 'view-shipping-provider-types') ? (
                    <Link
                      ...
                      className="text-base font-medium text-orange-700 underline-offset-2 hover:underline" style={{ color: '#c2410c' }}>
                    ...
                    {quote.billing_contact ? (
                      hasPermission(permissions, 'view-contacts') ? (
                        <Link
                          ...
                          className="block text-sm text-blue-600 hover:underline mt-1 transition-colors cursor-pointer" style={{ color: '#2563eb' }} onMouseEnter={e => (e.currentTarget.style.color = '#2563eb')} onMouseLeave={e => (e.currentTarget.style.color = '#2563eb')}
                        >
                          {quote.billing_contact.name}
                        </Link>
                      ) : (
                        <p className="text-sm mt-1">{quote.billing_contact.name}</p>
                      )
                    ) : (
                  ...
                  <div>
                    ...
                    {quote.shipping_contact ? (
                      hasPermission(permissions, 'view-contacts') ? (
                        ...
                        <p className="text-sm mt-1">{quote.shipping_contact.name}</p>
                      )
                    ) : (
                      <p className="text-sm mt-1">{t('-')}</p>
                    )}
                ...
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow className="bg-gray-50 border-t-2">
                      ...
                      <TableCell className="text-right font-semibold text-base py-3 px-4">{formatCurrency(subtotal)}</TableCell>
                    </TableRow>
        ...
        <Card className="shadow-sm">
          ...
          {showStream && (
            <CardContent className="p-0">
              {/* Add Comment Form */}
              {hasPermission(permissions, 'create-quotes') && <div className="sticky top-0 bg-white z-10 p-6 pb-6 border-b">
                                ...
                                <div>
                                  {editingComment === activity.id ? (
                                    ...
                                    <div className="flex items-start justify-between">
                                      ...
                                      {((activity.user_id === auth?.user?.id ) && hasPermission(permissions, 'edit-quotes') )&& (
                                        <Button
                                          size="sm"
                                          variant="ghost"
