...
export default function Categories() {
    ...
    return (
        <PageTemplate title={t('Categories')} url="/categories" breadcrumbs={breadcrumbs} noPadding>
                            ...
                            <>
                                ...
                                {categories?.total > (categories?.per_page || 10) && (
                                    <div className="border-t border-gray-200 dark:border-gray-700">
                                        <Pagination from={categories?.from || 0} to={categories?.to || 0} total={categories?.total || 0} links={categories?.links} entityName={t('categories')} onPageChange={(url) => router.get(url, {}, { preserveState: true, preserveScroll: true })} />
                                    </div>
                                )}
                            </>
                        ) : (
