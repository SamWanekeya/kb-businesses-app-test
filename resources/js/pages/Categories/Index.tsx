...
export default function Categories() {
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        setFormErrors({});
        if (formMode === 'create') {
            const toastId = toast.loading(translate('Creating category...'));
            ...
            const toastId = toast.loading(translate('Updating category...'));
    ...
    const handleDeleteConfirm = () => {
        const toastId = toast.loading(translate('Deleting category...'));
