...
export default function Brands() {
    ...
    return (
        <PageTemplate title={t('Brands')} url="/brands" breadcrumbs={breadcrumbs} noPadding>
                            ...
                            <>
                                ...
                                {brands?.total > (brands?.per_page || 10) && (
                                    <div className="border-t border-gray-200 dark:border-gray-700">
                                        <Pagination from={brands?.from || 0} to={brands?.to || 0} total={brands?.total || 0} links={brands?.links} entityName={t('brands')} onPageChange={(url) => router.get(url, {}, { preserveState: true, preserveScroll: true })} />
                                    </div>
                                )}
                            </>
                        ) : (
