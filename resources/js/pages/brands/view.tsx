...
import { Tag, Globe, Lock, FileText } from 'lucide-react';
        ...
        <DialogContent className="max-w-xl max-h-[90vh] overflow-y-auto p-0" onOpenAutoFocus={(e) => e.preventDefault()}>
            <DialogHeader className="px-6 pt-6 pb-4 border-b">
                <div className="flex items-center gap-3">
                    ...
                    <DialogTitle className="text-xl font-semibold">{t('Brand Details')}</DialogTitle>
                </div>
            </DialogHeader>
            ...
            <div className="px-6 py-4 pb-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        {record.website ? (
                            <a href={record.website} target="_blank" rel="noopener noreferrer" className="mt-1 text-sm font-medium text-primary hover:underline block">
                                {record.website}
                            </a>
                        ) : (
