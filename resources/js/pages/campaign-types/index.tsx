...
export default function CampaignTypes() {
    ...
    const breadcrumbs = [{ title: translate('Dashboard'), href: route('dashboard') }, { title: translate('Campaign Management') }, { title: translate('Campaign Types') }];
    ...
    return (
        ...
        >
                    ...
                    <div className="sticky top-4 rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <div className="border-b border-gray-200 p-6 dark:border-gray-700">
                            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
                                {formMode === 'create' ? translate('Add New Campaign Type') : translate('Edit Campaign Type')}
                            </h2>
                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                {formMode === 'create'
                                    ? translate('Fill in the details to create a new campaign type')
                            ...
                            <div className="flex items-center gap-3 border-t border-gray-200 pt-4 dark:border-gray-700">
                                {(canCreate || canEdit) && (
                                    <Button type="submit" className="flex-1">
                                        {formMode === 'create' ? translate('Add Campaign Type') : translate('Update Campaign Type')}
                                    </Button>
                                )}
                                {formMode === 'edit' && (
                        ...
                        {(campaignTypes?.data || []).length > 0 ? (
                            <>
                                {/* <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{translate('Campaign Types')}</h3>
                                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{translate('Manage campaign type categories for your campaigns.')}</p>
                                </div> */}
                                {/* Desktop Table */}
                                ...
                                {campaignTypes?.total > (campaignTypes?.per_page || 10) && (
                                    <div className="border-t border-gray-200 dark:border-gray-700">
                                        <Pagination
                                            ...
                                            entityName={translate('campaign types')}
                                            hidePerPage={true}
                            ...
                            <div className="p-12 text-center">
                                ...
                                <h3 className="mb-2 text-lg font-medium text-gray-900 dark:text-white">{translate('No campaign types found')}</h3>
                                <p className="mx-auto mb-6 max-w-sm text-gray-500 dark:text-gray-400">
                                    {hasActiveFilters()
                                        ? translate('No campaign types match your search criteria. Try adjusting your filters.')
                                        : translate('Create campaign types to categorize your campaigns.')}
                                </p>
                                {!hasActiveFilters() && canCreate && (
                                    <p className="text-sm text-gray-500 dark:text-gray-400">
                                        {translate('Use the form on the left to add your first campaign type.')}
                                    </p>
                                )}
                            </div>
                        )}
            ...
            <CrudDeleteModal
                ...
                entityName={translate('campaign type')}
            />
        </PageTemplate>
    );
}
