...
export default function TargetLists() {
    ...
    return (
        <PageTemplate title={t('Target Lists')} url="/target-lists" breadcrumbs={breadcrumbs} noPadding>
                            ...
                            <>
                                ...
                                {targetLists?.total > (targetLists?.per_page || 10) && (
                                    <div className="border-t border-gray-200 dark:border-gray-700">
                                        <Pagination from={targetLists?.from || 0} to={targetLists?.to || 0} total={targetLists?.total || 0} links={targetLists?.links} entityName={t('target lists')} onPageChange={(url) => router.get(url, {}, { preserveState: true, preserveScroll: true })} />
                                    </div>
                                )}
                            </>
                        ) : (
