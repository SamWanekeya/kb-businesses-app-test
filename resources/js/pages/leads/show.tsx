            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <h3 className="text-lg font-bold truncate">{formatCurrency(lead.value)}</h3>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <h3 className="text-lg font-bold truncate leading-tight">{lead.lead_status?.name || t('-')}</h3>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <h3 className="text-lg font-bold truncate leading-tight">{lead.lead_source?.name || t('-')}</h3>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <h3 className="text-lg font-bold truncate leading-tight">{window.appSettings?.formatDateTime(lead.created_at, false) || new Date(lead.created_at).toLocaleDateString()}</h3>
                </div>
          ...
          <Card className="shadow-sm">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                {hasPermission(permissions,'view-campaigns') && <Link href={route('campaigns.show', lead.campaign.id)}>
              ...
              <div className="space-y-4">
                {relatedAccounts.map((account: any) => (
                  <div key={account.id} className="flex items-center justify-between p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    {hasPermission(permissions,'view-accounts') && <Link href={route('accounts.show', account.id)}>
                      <Button variant="outline" size="sm" className="bg-white">
                        {t('View Account')}
                      </Button>
                    </Link>}
              ...
              <div className="space-y-4">
                {relatedContacts.map((contact: any) => (
                  <div key={contact.id} className="flex items-center justify-between p-4 bg-purple-50 rounded-lg border border-purple-200">
                    ...
                    {hasPermission(permissions,'view-contacts') && <Link href={route('contacts.show', contact.id)}>
                      <Button variant="outline" size="sm" className="bg-white">
                        {t('View Contact')}
                      </Button>
                    </Link>}
        ...
        <Card className="shadow-sm">
          ...
          {showStream && (
            <CardContent className="p-0">
              {/* Add Comment Form */}
              {hasPermission(permissions, 'create-leads') && <div className="sticky top-0 bg-white z-10 p-6 pb-6 border-b">
                                ...
                                <div>
                                  {editingComment === activity.id ? (
                                    ...
                                    <div className="flex items-start justify-between">
                                      ...
                                      {((activity.user_id === auth?.user?.id ) && hasPermission(permissions, 'edit-leads') )&& (
                                        <Button
                                          size="sm"
                                          variant="ghost"
