            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-lg font-bold leading-none">{formatCurrency(deliveryOrder.shipping_cost)}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-lg font-bold leading-none">{deliveryOrder.products?.length || 0}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-lg font-bold leading-none">{window.appSettings?.formatDateTime(deliveryOrder.delivery_date, false) || new Date(deliveryOrder.delivery_date).toLocaleDateString()}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-lg font-bold leading-none">{deliveryOrder.total_weight} kg</h3>
                </div>
              ...
              {deliveryOrder.sales_order && (
                <div className="p-6 bg-blue-50 rounded-xl border border-blue-200 hover:shadow-md hover:bg-blue-50/80 hover:border-blue-300 transition-all cursor-pointer">
                  ...
                  {hasPermission(permissions, 'view-sales-orders') ? (
                    ...
                    <p className="text-base font-medium text-blue-600">{deliveryOrder.sales_order.order_number} - {deliveryOrder.sales_order.name}</p>
                  )}
                </div>
              )}
              ...
              {deliveryOrder.account && (
                <div className="p-6 bg-green-50 rounded-xl border border-green-200 hover:shadow-md hover:bg-green-50/80 hover:border-green-300 transition-all cursor-pointer">
                  ...
                  {hasPermission(permissions, 'view-accounts') ? (
                    ...
                    <p className="text-base font-medium text-green-600">{deliveryOrder.account.name}</p>
                  )}
                </div>
              )}
              ...
              {deliveryOrder.contact && (
                <div className="p-6 bg-purple-50 rounded-xl border border-purple-200 hover:shadow-md hover:bg-purple-50/80 hover:border-purple-300 transition-all cursor-pointer">
                  ...
                  {hasPermission(permissions, 'view-contacts') ? (
                    ...
                    <p className="text-base font-medium text-purple-600">{deliveryOrder.contact.name}</p>
                  )}
                </div>
              )}
            </div>
