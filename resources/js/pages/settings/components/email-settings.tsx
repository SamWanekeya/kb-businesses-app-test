...
export default function EmailSettings() {
  ...
  return (
    <SettingsSection
      ...
      action={
        <Button type="submit" disabled={processing} form="email-settings-form" size="sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      <Label htmlFor="driver" className="font-medium" required>{t("Mail Driver")}</Label>
                    </div>
                    <Input
                      id="driver"
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <Server className="h-4 w-4 text-muted-foreground" />
                      <Label htmlFor="host" className="font-medium" required>{t("SMTP Host")}</Label>
                    </div>
                    <Input
                      id="host"
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <Server className="h-4 w-4 text-muted-foreground" />
                      <Label htmlFor="port" className="font-medium" required>{t("SMTP Port")}</Label>
                      <TooltipProvider>
                        <Tooltip>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      <Label htmlFor="username" className="font-medium" required>{t("SMTP Username")}</Label>
                    </div>
                    <Input
                      id="username"
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <Mail className="h-4 w-4 text-muted-foreground" />
                      <Label htmlFor="fromAddress" className="font-medium" required>{t("From Address")}</Label>
                    </div>
                    <Input
                      id="fromAddress"
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <User className="h-4 w-4 text-muted-foreground" />
                      <Label htmlFor="fromName" className="font-medium" required>{t("From Name")}</Label>
                    </div>
                    <Input
                      id="fromName"
