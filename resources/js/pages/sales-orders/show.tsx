            ...
            <div className="mx-auto space-y-6">
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-lg font-bold leading-none">{formatCurrency(salesOrder.total_amount)}</h3>
                                </div>
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-lg font-bold leading-none">{salesOrder.products?.length || 0}</h3>
                                </div>
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-lg font-bold leading-tight">{formatDate(salesOrder.order_date)}</h3>
                                </div>
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-lg font-bold leading-tight">{formatDate(salesOrder.delivery_date)}</h3>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        {salesOrder.billing_contact ? (
                                            hasPermission(permissions, 'view-contacts') ? (
                                                ...
                                                <p className="text-sm mt-1">{salesOrder.billing_contact.name}</p>
                                            )
                                        ) : (
                                    ...
                                    <div>
                                        ...
                                        {salesOrder.shipping_contact ? (
                                            hasPermission(permissions, 'view-contacts') ? (
                                                ...
                                                <p className="text-sm mt-1">{salesOrder.shipping_contact.name}</p>
                                            )
                                        ) : (
                                            <p className="text-sm mt-1">{t('-')}</p>
                                        )}
                ...
                <Card className="shadow-sm">
                    ...
                    {showStream && (
                        <CardContent className="p-0">
                            {/* Add Comment Form */}
                            {hasPermission(permissions, 'create-sales-orders') && <div className="sticky top-0 bg-white z-10 p-6 pb-6 border-b">
                                                                        ...
                                                                        <div>
                                                                            {editingComment === activity.id ? (
                                                                                ...
                                                                                <div className="flex items-start justify-between">
                                                                                    ...
                                                                                    {((activity.user_id === auth?.user?.id ) && hasPermission(permissions, 'edit-sales-orders') )&& (
                                                                                        <Button
                                                                                            size="sm"
                                                                                            variant="ghost"
