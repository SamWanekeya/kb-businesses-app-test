                        ...
                        <tr>
                            <td style={{ fontSize: '13px', verticalAlign: 'top' }}>
                                ...
                                <p style={{ margin: '0', lineHeight: '1.5' }}>
                                    ...
                                    <br />
                                    {formatValue(salesOrder.billing_contact?.email)}
                                    <br />
                                    {formatValue(salesOrder.billing_contact?.phone)}
                                    <br />
                                    {formatValue(salesOrder.billing_address)}
                                    <br />
                                    {formatValue(salesOrder.billing_postal_code)}
                                    <br />
                                    {formatValue(salesOrder.billing_city)} {formatValue(salesOrder.billing_state)}{' '}
                                    {formatValue(salesOrder.billing_country)}
                                </p>
                            </td>
                            <td style={{ fontSize: '13px', verticalAlign: 'top', textAlign: 'right' }}>
                                ...
                                <p style={{ margin: '0', lineHeight: '1.5' }}>
                                    ...
                                    <br />
                                    {formatValue(salesOrder.shipping_contact?.email)}
                                    <br />
                                    {formatValue(salesOrder.shipping_contact?.phone)}
                                    <br />
                                    {formatValue(salesOrder.shipping_address)}
                                    <br />
                                    {formatValue(salesOrder.shipping_postal_code)}
                                    <br />
                                    {formatValue(salesOrder.shipping_city)} {formatValue(salesOrder.shipping_state)}{' '}
                                    {formatValue(salesOrder.shipping_country)}
                                </p>
                            </td>
                        </tr>
                ...
                >
                    <tbody>
                        ...
                        <tr style={{ borderTop: `1px solid ${borderColor}`, borderBottom: `1px solid ${borderColor}` }}>
                            ...
                            <td style={{ padding: '0.75rem', textAlign: 'left', borderTop: `1px solid ${borderColor}` }}>
                                {salesOrder.totalQuantity || 0}
                            </td>
                            <td style={{ padding: '0.75rem', textAlign: 'left', borderTop: `1px solid ${borderColor}` }}>
                                {formatCurrency(salesOrder.totalRate || 0)}
                            </td>
                            <td style={{ padding: '0.75rem', textAlign: 'left', borderTop: `1px solid ${borderColor}` }}>
                                {formatCurrency(salesOrder.totalTaxPrice || 0)}
                            </td>
                            <td style={{ padding: '0.75rem', textAlign: 'left', borderTop: `1px solid ${borderColor}` }}>
                                {salesOrder.discount_apply === 1 ? formatCurrency(salesOrder.totalDiscount || 0) : '-'}
                            </td>
                            <td style={{ padding: '0.75rem', textAlign: 'left', borderTop: `1px solid ${borderColor}` }}>
                                {formatCurrency(salesOrder.sub_total || 0)}
                            </td>
                        </tr>
                        <tr>
