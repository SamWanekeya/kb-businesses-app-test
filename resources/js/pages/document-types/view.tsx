        ...
        <DialogContent className="max-h-[90vh] max-w-xl overflow-y-auto p-0" onOpenAutoFocus={(e) => e.preventDefault()}>
            <DialogHeader className="border-b px-6 pt-6 pb-4">
                <div className="flex items-center gap-3">
                    ...
                    <DialogTitle className="text-xl font-semibold">{translate('Document Type Details')}</DialogTitle>
                </div>
            </DialogHeader>
            ...
            <div className="space-y-4 px-6 py-4 pb-6">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-gray-900 dark:text-white">{record.type_name || '-'}</p>
                    </div>
                    <div>
                        <label className="flex items-center gap-2 text-sm font-medium text-gray-500">
