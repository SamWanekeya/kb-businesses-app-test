...
export default function DocumentTypes() {
    ...
    return (
        <PageTemplate title={t('Types')} url="/document-types" breadcrumbs={breadcrumbs} noPadding>
                            ...
                            <>
                                ...
                                {documentTypes?.total > (documentTypes?.per_page || 10) && (
                                    <div className="border-t border-gray-200 dark:border-gray-700">
                                        <Pagination from={documentTypes?.from || 0} to={documentTypes?.to || 0} total={documentTypes?.total || 0} links={documentTypes?.links} entityName={t('document types')} onPageChange={(url) => router.get(url, {}, { preserveState: true, preserveScroll: true })} />
                                    </div>
                                )}
                            </>
                        ) : (
