...
export default function AccountTypes() {
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        if (formMode === 'create') {
            const toastId = toast.loading(translate('Creating account type...'));
            ...
            const toastId = toast.loading(translate('Updating account type...'));
    ...
    const handleDeleteConfirm = () => {
        const toastId = toast.loading(translate('Deleting account type...'));
