...
import { BarChart3, Image, Layout, Plus, Trash2, Type, Users } from 'lucide-react';
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                        ...
                        />
                        {errors.about_title && <p className="text-sm text-red-600">{errors.about_title}</p>}
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <Textarea
                            ...
                            rows={4}
                        />
                        {errors.about_description && <p className="text-sm text-red-600">{errors.about_description}</p>}
                    </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-muted-foreground text-xs">{t('Enable parallax scrolling effect')}</p>
                    </div>
                </div>
            </div>
                ...
                <div className="space-y-4">
                    {(getSectionData('about').values || []).map((value, index) => (
                        <div key={index} className="rounded-xl border border-gray-200 bg-gray-50 p-5">
                            <div className="mb-4 flex items-center justify-between">
                                <h4 className="flex items-center gap-2 font-semibold text-gray-900">
                                    <span className="flex h-6 w-6 items-center justify-center rounded-full bg-teal-100 text-xs font-bold text-teal-600">
                                        {index + 1}
                                    </span>
                                    {t('Value')} {index + 1}
                                </h4>
