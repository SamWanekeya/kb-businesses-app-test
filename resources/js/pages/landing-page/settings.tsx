...
const SectionToggle = ({ sectionKey, data, updateSectionVisibility, t }: SectionToggleProps) => {
    return (
            ...
            <TooltipProvider>
                <Tooltip>
                    <TooltipTrigger asChild>
                        <div>
                            <Switch
                                checked={data.config_sections?.section_visibility?.[sectionKey] !== false}
...
export default function LandingPageSettings() {
    ...
    const sectionClasses = 'bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 min-[400px]:p-6 shadow-sm';
    ...
    const { data, setData, post, processing, errors } = useForm<Settings>({
        ...
        config_sections:
            settings.config_sections && settings.config_sections.sections && settings.config_sections.sections.length > 0
                ? {
    ...
    const breadcrumbs = [{ title: t('Dashboard'), href: route('dashboard') }, { title: t('Landing Page Settings') }];
    ...
    return (
        ...
        `}</style>
            <SettingsSection
                ...
                action={
                    <Button onClick={saveSettings} disabled={isLoading} size="sm" className="max-[650px]:px-2.5">
                        <Save className="mr-2 h-4 w-4 max-[650px]:mr-0" />
                        <span className="max-[650px]:hidden">{isLoading ? t('Saving...') : t('Save Changes')}</span>
                    </Button>
                }
            >
                {/* Mobile Sidebar Toggle */}
                <div className="mb-4 min-[1120px]:hidden">
                    <Button variant="outline" onClick={() => setSidebarOpen(!sidebarOpen)} className="flex w-full items-center justify-center gap-2">
                ...
                <div className="grid grid-cols-1 gap-8 min-[1120px]:grid-cols-4">
                    {/* Sidebar Navigation */}
                    <div className={`min-[1120px]:col-span-1 ${sidebarOpen ? 'block' : 'hidden min-[1120px]:block'}`}>
                        <div className="sticky top-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <div className="mb-4 flex items-center justify-between">
                                <h3 className="px-2 text-sm font-semibold text-gray-900 dark:text-gray-100">{t('Sections')}</h3>
                                <button
                                    onClick={() => setSidebarOpen(false)}
                                    className="cursor-pointer rounded-md p-1 hover:bg-gray-100 min-[1120px]:hidden dark:hover:bg-gray-700"
                                >
                                    <X className="h-4 w-4" />
                                </button>
                            </div>
                            ...
                            <div className="mb-4 px-2">
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="h-8 border-gray-200 pl-10 text-sm dark:border-gray-700 dark:bg-gray-900"
                                    />
                                </div>
                            </div>
                            <nav className="space-y-1">
                                {(() => {
                                    const allSections = [
                                        ...
                                        { key: 'plans', label: t('Plans'), icon: CreditCard, group: 'Social' },
                                    ...
                                    return (
                                        <>
                                            {/* Setup Group */}
                                            <div className="mb-4">
                                                <div className="mb-2 px-2 text-xs font-medium tracking-wider text-gray-500 uppercase dark:text-gray-400">
                                                    {t('Setup')}
                                                </div>
                                                {[
                                            ...
                                            <div className="mb-4">
                                                ...
                                                {[
                                                    ...
                                                    { key: 'plans', label: t('Plans'), icon: CreditCard },
                                                ].map((section) => (
                                                    <button
                                                        key={section.key}
                                                        onClick={() => {
                    ...
                    {/* Main Content */}
                    <div className="space-y-6 min-[1120px]:col-span-3">
                        {/* Section Header */}
                        ...
                        {activeSection === 'general' && (
                            <div className="space-y-6">
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6 dark:border-gray-700 dark:bg-gray-800">
                                    <div className="mb-6 flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                                {t('Basic organization details for your landing page')}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="contact_address" required>
                                                {t('Contact Address')}
                                            </Label>
                                            <Input
                                                id="contact_address"
                                    ...
                                    <div
                                        className="mt-6 rounded-lg border bg-gradient-to-r p-4"
                                        style={{ backgroundColor: brandColor + '10', borderColor: brandColor + '30' }}
                                    >
                                        <h4 className="mb-3 text-sm font-medium" style={{ color: brandColor }}>
                                            {t('Theme Colors')}
                                        </h4>
                        ...
                        {activeSection === 'header' && (
                            <div className="space-y-6">
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    <div className="mb-6 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Label className="text-sm max-[470px]:hidden">{t('Enable Section')}</Label>
                                            <TooltipProvider>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <div>
                                                    ...
                                                    <TooltipContent className="min-[470px]:hidden">
                                                        <p>{t('Enable Section')}</p>
                                                    </TooltipContent>
                                                </Tooltip>
                                            </TooltipProvider>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        <div className="space-y-3">
                                            ...
                                            <p className="text-muted-foreground text-xs">{t('Make header background transparent')}</p>
                                        </div>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <select
                                                ...
                                                value={getSectionData('header').button_style || 'solid'}
                            ...
                            <div className="space-y-6">
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    <div className="mb-6 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Label className="text-sm max-[520px]:hidden">{t('Enable Section')}</Label>
                                            <TooltipProvider>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <div>
                                                    ...
                                                    <TooltipContent className="min-[520px]:hidden">
                                                        <p>{t('Enable Section')}</p>
                                                    </TooltipContent>
                                                </Tooltip>
                                            </TooltipProvider>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <Input
                                                ...
                                                max="1000"
                                            />
                                            <p className="text-muted-foreground text-xs">{t('Height in pixels (300-1000)')}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        <div className="space-y-3">
                                            <Label htmlFor="hero_title" className="flex items-center gap-2 text-sm font-medium text-gray-900">
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="hero_subtitle" className="flex items-center gap-2 text-sm font-medium text-gray-900">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            />
                                            <p className="text-muted-foreground text-xs">{t('Small announcement text shown above the title')}</p>
                                        </div>
                                ...
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    ...
                                    <div className="space-y-4">
                                        {(getSectionData('hero').stats || []).map((stat, index) => (
                                            <div key={index} className="grid grid-cols-2 gap-4 rounded-lg border p-4">
                                                <div className="space-y-3">
                                ...
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    ...
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <p className="text-muted-foreground text-xs">{t('Add overlay on background image')}</p>
                                        </div>
                            ...
                            <div className="space-y-6">
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    <div className="mb-6 flex items-center justify-between">
                                        ...
                                        <SectionToggle sectionKey="screenshots" data={data} updateSectionVisibility={updateSectionVisibility} t={t} />
                                    </div>
                                ...
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    ...
                                    <div className="space-y-4">
                                        {(getSectionData('screenshots').screenshots_list || []).map((screenshot, index) => (
                                            <div key={index} className="rounded-xl border border-gray-200 bg-gray-50 p-3 min-[400px]:p-5">
                                                <div className="mb-4 flex items-center justify-between">
                                                    ...
                                                    <Button
                                                        ...
                                                        className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                                                        onClick={() => {
                                                            const newScreenshots = (getSectionData('screenshots').screenshots_list || []).filter(
                                                                (_, i) => i !== index,
                                                            );
                                        ...
                                        <Button
                                            type="button"
                                            variant="outline"
                                            className="w-full border-2 max-[400px]:px-2.5"
                                            style={{ color: brandColor, borderColor: brandColor }}
                                            onClick={() => {
                                                const newScreenshots = [
                                                    ...(getSectionData('screenshots').screenshots_list || []),
                                        ...
                                        >
                                            <Plus className="mr-0 h-4 w-4 min-[400px]:mr-2" />
                                            <span className="max-[400px]:hidden">{t('Add Screenshot')}</span>
                                        </Button>
                                    </div>
                                </div>
                            </div>
              ...
              />
                                            ...
                                            <div key={index} className="rounded-xl border border-gray-200 bg-gray-50 p-3 min-[400px]:p-5">
                                                <div className="mb-4 flex items-center justify-between">
                                                    ...
                                                    <Button
                                                        ...
                                                        className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                                                        onClick={() => {
                                                            const newReasons = (getSectionData('why_choose_us').reasons || []).filter(
                                                                (_, i) => i !== index,
                                                            );
                                ...
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    ...
                                    <div className="space-y-4">
                                        {(getSectionData('why_choose_us').stats || []).map((stat, index) => (
                                            <div key={index} className="grid grid-cols-1 gap-4 rounded-lg border p-4 sm:grid-cols-3">
                                                <div className="space-y-3">
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        <Button
                                                            ...
                                                            className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                                                            onClick={() => {
                                                                const newStats = (getSectionData('why_choose_us').stats || []).filter(
                                                                    (_, i) => i !== index,
                                                                );
                                                                updateSectionData('why_choose_us', { stats: newStats });
                                                            }}
                            ...
                            <div className="space-y-6">
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    <div className="mb-6 flex items-center justify-between">
                                        ...
                                        <SectionToggle sectionKey="team" data={data} updateSectionVisibility={updateSectionVisibility} t={t} />
                                    </div>
                                        ...
                                        <Button
                                            ...
                                            onClick={() => {
                                                const newMembers = [
                                                    ...
                                                    { name: '', role: '', bio: '', image: '', linkedin: '', twitter: '', email: '' },
                                                ];
                                                updateSectionData('team', { members: newMembers });
                                            }}
                                        >
                                            <Plus className="mr-0 h-4 w-4 min-[400px]:mr-2" />
                                            <span className="max-[400px]:hidden">{t('Add Team Member')}</span>
                                        </Button>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    ...
                                    <div className="space-y-4">
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        <Button
                                                            ...
                                                            className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                                                            onClick={() => {
                                                                const newStats = (getSectionData('testimonials').trust_stats || []).filter(
                                                                    (_, i) => i !== index,
                                                                );
                                                                updateSectionData('testimonials', { trust_stats: newStats });
                                                            }}
                                        ...
                                        >
                                            <Plus className="mr-0 h-4 w-4 min-[400px]:mr-2" />
                                            <span className="max-[400px]:hidden">{t('Add Trust Statistic')}</span>
                                        </Button>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-4">
                                        {(getSectionData('testimonials').testimonials || []).map((testimonial, index) => (
                                            <div key={index} className="rounded-xl border border-gray-200 bg-gray-50 p-3 min-[400px]:p-5">
                                                <div className="mb-4 flex items-center justify-between">
                                                    <h4 className="flex items-center gap-2 font-semibold text-gray-900">
                                                        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-lime-100 text-xs font-bold text-lime-600">
                                                            {index + 1}
                                                        </span>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                                                        onClick={() => {
                                                            const newTestimonials = (getSectionData('testimonials').testimonials || []).filter(
                                                                (_, i) => i !== index,
                                                            );
                                        ...
                                        <Button
                                            ...
                                            onClick={() => {
                                                const newTestimonials = [
                                                    ...
                                                    { name: '', role: '', organization: '', content: '', rating: 5 },
                                                ];
                                                updateSectionData('testimonials', { testimonials: newTestimonials });
                                            }}
                                        >
                                            <Plus className="mr-0 h-4 w-4 min-[400px]:mr-2" />
                                            <span className="max-[400px]:hidden">{t('Add Default Testimonial')}</span>
                                        </Button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    <div className="mb-6 flex items-center justify-between">
                                        ...
                                        <SectionToggle sectionKey="plans" data={data} updateSectionVisibility={updateSectionVisibility} t={t} />
                                    </div>
                                ...
                                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                                    <div className="flex items-start">
                                        <Info className="mt-0.5 mr-2 h-5 w-5 text-blue-600" />
                                        <div>
                                            <h4 className="mb-1 text-sm font-medium" style={{ color: brandColor }}>
                                                {t('Plans Management')}
                                            </h4>
                            ...
                            <div className="space-y-6">
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    <div className="mb-6 flex items-center justify-between">
                                        ...
                                        <SectionToggle sectionKey="faq" data={data} updateSectionVisibility={updateSectionVisibility} t={t} />
                                    </div>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="space-y-3">
                                                        ...
                                                        <Textarea
                                                            ...
                                                            placeholder={t('advocate allows you to manage law firm...')}
                                                            rows={3}
                                                        />
                                                    </div>
                                                </div>
                            ...
                            <div className="space-y-6">
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    <div className="mb-6 flex items-center justify-between">
                                        ...
                                        <SectionToggle sectionKey="newsletter" data={data} updateSectionVisibility={updateSectionVisibility} t={t} />
                                    </div>
                                ...
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    ...
                                    <div className="space-y-4">
                                            ...
                                            <div key={index} className="rounded-xl border border-gray-200 bg-gray-50 p-3 min-[400px]:p-5">
                                                <div className="mb-4 flex items-center justify-between">
                                                    ...
                                                    <Button
                                                        ...
                                                        className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                                                        onClick={() => {
                                                            const newBenefits = (getSectionData('newsletter').benefits || []).filter(
                                                                (_, i) => i !== index,
                                                            );
                                                ...
                                                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                                    ...
                                                    <div className="space-y-3">
                                                        ...
                                                        <Input
                                                            ...
                                                            placeholder={t('Stay informed about the latest Advocate SaaS features and improvements.')}
                                                        />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        >
                                            <Plus className="mr-0 h-4 w-4 min-[400px]:mr-2" />
                                            <span className="max-[400px]:hidden">{t('Add Benefit')}</span>
                                        </Button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    <div className="mb-6 flex items-center justify-between">
                                        ...
                                        <SectionToggle sectionKey="contact" data={data} updateSectionVisibility={updateSectionVisibility} t={t} />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <Textarea
                                                ...
                                                placeholder={t('Have questions about Advocate SaaS ?...')}
                                                rows={3}
                                            />
                                        </div>
                            ...
                            <div className="space-y-6">
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                    <div className="mb-6 flex items-center justify-between">
                                        ...
                                        <SectionToggle sectionKey="footer" data={data} updateSectionVisibility={updateSectionVisibility} t={t} />
                                    </div>
                                            ...
                                            <div key={index} className="rounded-xl border border-gray-200 bg-gray-50 p-5">
                                                <div className="mb-4 flex items-center justify-between">
                                                    ...
                                                    <Button
                                                        ...
                                                        className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                                                        onClick={() => {
                                                            const newSocials = (getSectionData('footer').social_links || []).filter(
                                                                (_, i) => i !== index,
                                                            );
                                    ...
                                    <div className="space-y-6">
                                        {['product', 'organization', 'support', 'legal'].map((category) => (
                                            <div key={category} className="space-y-4">
                                                ...
                                                <h4 className="font-medium">
                                                    {getSectionData('footer').section_titles?.[category] ||
                                                                ...
                                                                <Button
                                                                    ...
                                                                    onClick={() => {
                                                                        ...
                                                                        if (newLinks[category]) {
                                                                            newLinks[category] = newLinks[category].filter(
                        ...
                        {activeSection === 'design' && (
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center">
                                        <Image className="text-muted-foreground mr-2 h-5 w-5" />
                                ...
                                <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm min-[400px]:p-6">
                                        ...
                                        {(data.config_sections?.section_order || []).map((sectionKey, index) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`flex cursor-move items-center gap-3 rounded-lg border p-4 transition-all hover:shadow-md ${
                                                        isEnabled ? 'border-gray-200 bg-white' : 'border-gray-300 bg-gray-50 opacity-60'
                                                    }`}
                                                >
                                                    ...
                                                    <div className="flex flex-1 items-center justify-between">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-gray-500">{isEnabled ? t('Enabled') : t('Disabled')}</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-center gap-2">
                                    ...
                                    <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4">
                                        <div className="flex items-start">
                                            <Info className="mt-0.5 mr-2 h-5 w-5 text-blue-600" />
                                            <div>
                                                <h4 className="mb-1 text-sm font-medium text-blue-900">{t('How to reorder')}</h4>
                        ...
                        {activeSection === 'advanced' && (
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center">
                                        <Code className="text-muted-foreground mr-2 h-5 w-5" />
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        />
                                        <p className="text-muted-foreground text-xs">{t('Add custom CSS to override default styles')}</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Textarea
                                            ...
                                            className="font-mono text-sm"
                                        />
                                        <p className="text-muted-foreground text-xs">{t('Add custom JavaScript for advanced functionality')}</p>
                                    </div>
                                </div>
                            </div>
                        )}
