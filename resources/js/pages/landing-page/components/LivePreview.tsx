...
export default function LivePreview({ data, activeSection }: LivePreviewProps) {
  ...
  return (
    <div className="sticky top-20 space-y-6">
      ...
      {['hero', 'features', 'about'].includes(activeSection) && <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-4">
