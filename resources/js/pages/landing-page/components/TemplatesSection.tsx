        ...
        <div className="p-4 border-t border-gray-100">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="p-1.5 bg-white rounded-full shadow-sm hover:bg-gray-50 transition-colors border border-gray-200 cursor-pointer"
        ...
        {(layout === 'carousel' || layout === 'slider') && (
          ...
          <div className="relative mb-12">
            ...
            <div className="absolute top-1/2 left-0 transform -translate-y-1/2 -translate-x-6 z-10">
              <button
                onClick={prevSlide}
                className="w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center hover:bg-gray-50 transition-colors cursor-pointer"
            ...
            <div className="flex justify-center mt-6 gap-2">
              {Array.from({ length: totalSlides }).map((_, index) => (
                <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all cursor-pointer ${currentSlide === index ? 'bg-gray-800 w-6' : 'bg-gray-300'}`}
                ...
                >
                  <div className="md:w-2/5 h-48 md:h-72 overflow-hidden relative">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-30 transition-all flex items-center justify-center opacity-0 hover:opacity-100">
                      <button
                        className="p-2 bg-white rounded-full shadow-sm hover:bg-gray-50 transition-colors cursor-pointer"
                        aria-label="Preview template"
                      >
