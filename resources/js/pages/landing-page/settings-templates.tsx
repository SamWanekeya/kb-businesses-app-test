...
import { Image, Search, Type } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="mb-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
                        {visibleTemplates.map((template) => {
                            ...
                            const isSelected = templatesList.some((t: any) => t && t.name && template.name && t.name === template.name);
                ...
                <div className="mt-6">
                    <h4 className="mb-3 font-medium">{t('Selected Templates')}</h4>
                                ...
                                {(Array.isArray(getSectionData('templates').templates_list) ? getSectionData('templates').templates_list : [])
                                    ...
                                    .map((template: any, index: number) => (
                                        <TemplateListItem
                                            ...
                                            template={template}
                                            onRemove={() => {
                                                const newTemplates = (getSectionData('templates').templates_list || []).filter(
