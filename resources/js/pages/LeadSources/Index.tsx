...
export default function LeadSources() {
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        if (formMode === 'create') {
            const toastId = toast.loading(translate('Creating lead source...'));
            ...
            const toastId = toast.loading(translate('Updating lead source...'));
    ...
    const handleDeleteConfirm = () => {
        const toastId = toast.loading(translate('Deleting lead source...'));
