...
export default function ShippingProviderTypes() {
    ...
    return (
        <PageTemplate title={t('Shipping Provider Types')} url="/shipping-provider-types" breadcrumbs={breadcrumbs} noPadding>
                            ...
                            <>
                                ...
                                {shippingProviderTypes?.total > (shippingProviderTypes?.per_page || 10) && (
                                    <div className="border-t border-gray-200 dark:border-gray-700">
                                        <Pagination from={shippingProviderTypes?.from || 0} to={shippingProviderTypes?.to || 0} total={shippingProviderTypes?.total || 0} links={shippingProviderTypes?.links} entityName={t('shipping provider types')} onPageChange={(url) => router.get(url, {}, { preserveState: true, preserveScroll: true })} />
                                    </div>
                                )}
                            </>
                        ) : (
