...
export default function AnnouncementCategories() {
    ...
    return (
        <PageTemplate title={t('Announcement Categories')} breadcrumbs={breadcrumbs} noPadding>
                            ...
                            <>
                                ...
                                {categories?.total > (categories?.per_page || 10) && (
                                    <div className="border-t border-gray-200 dark:border-gray-700">
                                        <Pagination from={categories?.from || 0} to={categories?.to || 0} total={categories?.total || 0} links={categories?.links} entityName={t('announcement categories')} onPageChange={(url) => router.get(url, {}, { preserveState: true, preserveScroll: true })} />
                                    </div>
                                )}
                            </>
                        ) : (
