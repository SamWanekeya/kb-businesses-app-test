...
export default function AnnouncementCategories() {
        ...
        if (formMode === 'create') {
            router.post(route('announcement-categories.store'), formData, {
                ...
                onError: (errors) => {
                    ...
                    toast.error(t('Failed to create announcement category.'));
                },
            });
        } else {
            router.put(route('announcement-categories.update', currentItem.id), formData, {
                ...
                onError: (errors) => {
                    setFormErrors(errors);
                    toast.error(t('Failed to update announcement category.'));
                },
            });
        }
    };
    ...
    const handleDeleteConfirm = () => {
        router.delete(route('announcement-categories.destroy', currentItem.id), {
            ...
            onError: (errors) => {
                setIsDeleteModalOpen(false);
                toast.error(`${t('Failed to delete announcement category')}: ${Object.values(errors).join(', ')}`);
            },
        });
    };
    ...
    return (
        <PageTemplate
            ...
            description={t('Manage announcement categories for your announcements.')}
                    ...
                    <div className="sticky top-4 rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <div className="border-b border-gray-200 p-6 dark:border-gray-700">
                            ...
                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                {formMode === 'create'
                                    ? t('Fill in the details to create a new announcement category')
                                    : t('Update the announcement category details below')}
                            </p>
                        </div>
                        <form onSubmit={handleFormSubmit} className="space-y-4 p-6">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder={t('e.g. Product Updates, Organization News, Events')}
                        ...
                        <div className="space-y-4">
                            <div className="flex gap-2">
                                <div className="relative flex-1">
                                    ...
                                    <Input
                                        type="text"
                                        placeholder={t('Search announcement categories...')}
                                        value={searchTerm}
                        ...
                        {(categories?.data || []).length > 0 ? (
                                ...
                                {categories?.total > (categories?.per_page || 10) && (
                                    <div className="border-t border-gray-200 dark:border-gray-700">
                                        <Pagination
                                            ...
                                            entityName={t('announcement categories')}
                                            hidePerPage={true}
                            ...
                            <div className="p-12 text-center">
                                ...
                                <p className="mx-auto mb-6 max-w-sm text-gray-500 dark:text-gray-400">
                                    {hasActiveFilters()
                                        ? t('No announcement categories match your search criteria. Try adjusting your filters.')
                                        : t('Create announcement categories to organize your announcements.')}
                                </p>
                                {!hasActiveFilters() && canCreate && (
                                    <p className="text-sm text-gray-500 dark:text-gray-400">
                                        {t('Use the form on the left to add your first announcement category.')}
                                    </p>
                                )}
                            </div>
                        )}
