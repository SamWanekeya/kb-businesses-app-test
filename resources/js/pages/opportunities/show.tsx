            ...
            <div className="mx-auto space-y-6">
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-lg font-bold leading-none">{formatCurrency(opportunity.amount)}</h3>
                                </div>
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-lg font-bold leading-none">{opportunity.products?.length || 0}</h3>
                                </div>
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-lg font-bold leading-tight">{formatDate(opportunity.close_date)}</h3>
                                </div>
                                    ...
                                    <div className="mt-2">
                                        {opportunity.opportunity_stage ? (
                                            <div className="flex items-center gap-2">
                                                ...
                                                ></div>
                                                <span className="text-lg font-bold">{opportunity.opportunity_stage.name}</span>
                                            </div>
                                        ) : (
                                        ...
                                        {opportunity.opportunity_stage ? (
                                            <div className="flex items-center gap-2 mt-1">
                                                <div
                                                    ...
                                                    style={{ backgroundColor: opportunity.opportunity_stage.color }}
                                                ></div>
                                                <p className="text-sm mt-1">{opportunity.opportunity_stage.name}</p>
                                            </div>
                                        ) : (
                        ...
                        {opportunity.account && (
                            <div className="flex items-center justify-between p-6 bg-green-50 rounded-xl border border-green-200 hover:shadow-md transition-shadow">
                                <div>
                                    ...
                                    <span className='text-sm font-medium text-green-700 hover:text-green-900 transition-colors'>{opportunity.account.name}</span>
                                </div>
                                {hasPermission(permissions, 'view-accounts') && <Link href={route('accounts.show', opportunity.account.id)}>
                        ...
                        {opportunity.contact && (
                            <div className="flex items-center justify-between p-6 bg-purple-50 rounded-xl border border-purple-200 hover:shadow-md transition-shadow">
                                <div>
                                    ...
                                    <span className="text-sm font-medium text-purple-700 hover:text-purple-900 hover:underline transition-colors">{opportunity.contact.name}</span>
                                </div>
                                            ...
                                            return (
                                                <TableRow key={index} className="border-b hover:bg-gray-50">
                                                    ...
                                                    <TableCell className="text-right text-base py-4 px-4">
                                                        {product.tax ? (
                                                            <div className="text-sm">
                                                                <div className="font-semibold text-gray-700">{product.tax.name} ({parseFloat(product.tax.rate).toFixed(2)}%)</div>
                                                                <div className="text-gray-400 font-medium">{formatCurrency(taxAmount)}</div>
                                                            </div>
                                                        ) : (
                                                    ...
                                                    <TableCell className="text-right font-semibold text-base py-4 px-4">
                                                        <span className="text-green-600">{formatCurrency(lineTotal + taxAmount)}</span>
                                                    </TableCell>
                                                </TableRow>
                                            );
                                        })}
                ...
                <Card className="shadow-sm">
                    ...
                    {showStream && (
                        <CardContent className="p-0">
                            {/* Add Comment Form */}
                            {hasPermission(permissions, 'create-opportunities') && <div className="sticky top-0 bg-white z-10 p-6 pb-6 border-b">
                                                                        ...
                                                                        <div>
                                                                            {editingComment === activity.id ? (
                                                                                ...
                                                                                <div className="flex items-start justify-between">
                                                                                    ...
                                                                                    {((activity.user_id === auth?.user?.id ) && hasPermission(permissions, 'edit-opportunities') )&& (
                                                                                        <Button
                                                                                            size="sm"
                                                                                            variant="ghost"
