...
export default function OpportunityCreate() {
    ...
    const { data, setData, setError, clearErrors, post, processing, errors } = useForm({
        ...
        account_id: '',
        contact_id: '',
        opportunity_stage_id: prefilledOpportunityStageId || '',
    ...
    return (
        <PageTemplate
            title={translate('Create Opportunity')}
            description={translate('Fill in the details to create a new opportunity')}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="mt-6 flex flex-col-reverse justify-end gap-3 sm:flex-row sm:gap-4">
                    ...
                    <Button type="submit" disabled={processing} className="w-full sm:w-auto">
                        {processing ? translate('Creating...') : translate('Save')}
                    </Button>
                </div>
            </form>
        </PageTemplate>
