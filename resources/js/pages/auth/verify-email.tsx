...
export default function VerifyEmail({ status }: { status?: string }) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('verification.send'), {
            ...
            onError: () => {
                toast.error(translate('Failed to send verification email. Please try again.'));
            },
        });
    };
    ...
    return (
        <AuthLayout
            ...
            description={translate('Please verify your email address by clicking on the link we just emailed to you.')}
