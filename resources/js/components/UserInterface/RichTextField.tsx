...
import { RichTextEditor, RichTextEditorRef } from '@components/UserInterface/RichTextEditor';
...
const RichTextField = forwardRef<RichTextFieldRef, RichTextFieldProps>(
    ({ label, name, value = '', onChange, className, error, required, disabled = false }, ref) => {
