...
function Sidebar({
    ...
    return (
        <div
            ...
            className="group peer text-sidebar-foreground hidden shadow-xl md:block"
            data-state={state}
...
function SidebarMenuSkeleton({
    ...
    return (
        <div
            ...
            className={cn('flex h-8 items-center gap-2 rounded-md px-2', active ? 'bg-primary/10' : '', className)}
            {...props}
        >
            {showIcon && <Skeleton className={cn('size-4 rounded-md', active ? 'bg-primary' : '')} data-sidebar="menu-skeleton-icon" />}
            <Skeleton
...
function SidebarMenuSubItem({ className, ...props }: React.ComponentProps<'li'>) {
    return (
        <li
            ...
            className={cn(
                'group/menu-sub-item [&:has([data-active=true])]:before:bg-primary relative [&:has([data-active=true])]:before:absolute [&:has([data-active=true])]:before:top-0 [&:has([data-active=true])]:before:left-[-11px] [&:has([data-active=true])]:before:h-full [&:has([data-active=true])]:before:w-[2px] [&:has([data-active=true])]:before:rounded-full',
                className,
            )}
            {...props}
        />
    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                'data-[active=true]:text-primary data-[active=true]:bg-transparent data-[active=true]:font-semibold',
                size === 'sm' && 'text-xs',
                size === 'md' && 'text-sm',
                'group-data-[collapsible=icon]:hidden',
                className,
