    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-4">
                ...
                <Alert>
                    <AlertCircle className="h-4 w-4" />
                    <AlertDescription>{t('You will be redirected to CinetPay to complete your payment securely.')}</AlertDescription>
                </Alert>

                <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4">
                    <h4 className="mb-2 font-medium text-yellow-900">{t('Supported Payment Methods')}</h4>
                ...
                <div className="text-muted-foreground text-center text-xs">{t('Powered by CinetPay - African payment gateway')}</div>
            </CardContent>
        </Card>
    );
}
