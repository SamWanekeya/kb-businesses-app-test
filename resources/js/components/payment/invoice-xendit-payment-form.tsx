    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-4">
                ...
                <Alert>
                    <AlertCircle className="h-4 w-4" />
                    <AlertDescription>{t('You will be redirected to Xendit to complete your payment securely.')}</AlertDescription>
                </Alert>
                ...
                <div className="text-muted-foreground text-center text-xs">{t('Powered by Xendit - Secure payment processing')}</div>
            </CardContent>
        </Card>
    );
}
