...
export const StatusBadge: React.FC<StatusBadgeProps> = ({ value, colorMap = {}, defaultColor = 'bg-gray-100 text-gray-800' }) => {
...
export const PriceColumn: React.FC<PriceColumnProps> = ({ value, currency = 'USD', locale = 'en-US' }) => {
...
export const DateColumn: React.FC<DateColumnProps> = ({ value, format = { dateStyle: 'medium' }, locale = 'en-US' }) => {
    if (!value) return <span>-</span>;
