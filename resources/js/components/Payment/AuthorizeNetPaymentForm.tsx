...
import { AlertCircle, CheckCircle, CreditCard, Info, Loader2 } from 'lucide-react';
...
export function AuthorizeNetPaymentForm({
    ...
    const handlePayment = async () => {
        ...
        router.post(
            route('subscriptions.authorizenet.payment'),
            {
                plan_id: planId,
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        />
                        {validationErrors.card_number && <p className="mt-1 text-sm text-red-500">{validationErrors.card_number}</p>}
                    </div>
