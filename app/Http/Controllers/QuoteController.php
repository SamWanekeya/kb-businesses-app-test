...
class QuoteController extends Controller
{
    public function index(Request $request)
    {
        ...
        $opportunityQuery = Opportunity::where('created_by', createdBy());
        ...
        return Inertia::render('quotes/index', [
            ...
            'users' => $users,
            'allUsers' => $allUsers,
            'filters' => $request->all(['search', 'status', 'account_id', 'opportunity_id', 'assigned_to', 'sort_field', 'sort_direction', 'per_page', 'page']),
