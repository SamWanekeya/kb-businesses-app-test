...
class PaymentSettingController extends Controller
{
    ...
    {
        $superAdminId = \App\Models\User::where('type', 'super_admin')->first()?->id;
    ...
    {
        return [
            'is_manual_payment_mode_enabled' => $request->boolean('is_manual_payment_mode_enabled'),
            'is_bank_payment_mode_enabled' => $request->boolean('is_bank_payment_mode_enabled'),
            'is_stripe_payment_mode_enabled' => $request->boolean('is_stripe_payment_mode_enabled'),
            'is_paypal_payment_mode_enabled' => $request->boolean('is_paypal_payment_mode_enabled'),
            'is_razorpay_payment_mode_enabled' => $request->boolean('is_razorpay_payment_mode_enabled'),
            'is_mercadopago_payment_mode_enabled' => $request->boolean('is_mercadopago_payment_mode_enabled'),
            'is_paystack_payment_mode_enabled' => $request->boolean('is_paystack_payment_mode_enabled'),
            'is_flutterwave_payment_mode_enabled' => $request->boolean('is_flutterwave_payment_mode_enabled'),
            'is_paytabs_payment_mode_enabled' => $request->boolean('is_paytabs_payment_mode_enabled'),
            'is_skrill_payment_mode_enabled' => $request->boolean('is_skrill_payment_mode_enabled'),
            'is_coingate_payment_mode_enabled' => $request->boolean('is_coingate_payment_mode_enabled'),
            'is_payfast_payment_mode_enabled' => $request->boolean('is_payfast_payment_mode_enabled'),
            'is_tap_payment_mode_enabled' => $request->boolean('is_tap_payment_mode_enabled'),
            'is_xendit_payment_mode_enabled' => $request->boolean('is_xendit_payment_mode_enabled'),
            'is_paytr_payment_mode_enabled' => $request->boolean('is_paytr_payment_mode_enabled'),
            'is_mollie_payment_mode_enabled' => $request->boolean('is_mollie_payment_mode_enabled'),
            'is_toyyibpay_payment_mode_enabled' => $request->boolean('is_toyyibpay_payment_mode_enabled'),
            'is_benefit_payment_mode_enabled' => $request->boolean('is_benefit_payment_mode_enabled'),
            'is_iyzipay_payment_mode_enabled' => $request->boolean('is_iyzipay_payment_mode_enabled'),
            'is_aamarpay_payment_mode_enabled' => $request->boolean('is_aamarpay_payment_mode_enabled'),
            'is_midtrans_payment_mode_enabled' => $request->boolean('is_midtrans_payment_mode_enabled'),
            'is_yookassa_payment_mode_enabled' => $request->boolean('is_yookassa_payment_mode_enabled'),
            'is_nepalste_payment_mode_enabled' => $request->boolean('is_nepalste_payment_mode_enabled'),
            'is_paiement_payment_mode_enabled' => $request->boolean('is_paiement_payment_mode_enabled'),
            'is_cinetpay_payment_mode_enabled' => $request->boolean('is_cinetpay_payment_mode_enabled'),
            'is_payhere_payment_mode_enabled' => $request->boolean('is_payhere_payment_mode_enabled'),
            'is_fedapay_payment_mode_enabled' => $request->boolean('is_fedapay_payment_mode_enabled'),
            'is_authorizenet_payment_mode_enabled' => $request->boolean('is_authorizenet_payment_mode_enabled'),
            'is_khalti_payment_mode_enabled' => $request->boolean('is_khalti_payment_mode_enabled'),
            'is_easebuzz_payment_mode_enabled' => $request->boolean('is_easebuzz_payment_mode_enabled'),
            'is_ozow_payment_mode_enabled' => $request->boolean('is_ozow_payment_mode_enabled'),
            'is_cashfree_payment_mode_enabled' => $request->boolean('is_cashfree_payment_mode_enabled'),
    ...
    private function filterSensitiveData(array $settings): array
    {
        ...
        $enabledKeys = [
            ...
            'is_toyyibpay_payment_mode_enabled', 'is_benefit_payment_mode_enabled',
            'is_iyzipay_payment_mode_enabled', 'is_aamarpay_payment_mode_enabled', 'is_midtrans_payment_mode_enabled', 'is_yookassa_payment_mode_enabled',
