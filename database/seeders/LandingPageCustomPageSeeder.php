    ...
    public function run(): void
    {
        $pages = [
            ...
            [
                ...
                'content' => "Please read these terms carefully before using our Kakbima platform. By accessing or using our services, you agree to these terms.<br><br>
                                <b>Acceptance of Terms:</b> By creating an account or using our Kakbima product, you confirm that you have read, understood, and agree to be bound by these Terms of Service. If you do not agree, you may not use the platform.<br><br>
                                ...
                                <b>Limitation of Liability:</b> Our organization shall not be held liable for any indirect, incidental, or consequential damages arising from your use of the Kakbima platform.",
            ...
            [
                'title' => 'FAQ',
                'slug' => 'faq',
                'content' => "Find quick answers to the most <b>common questions</b> about using our Kakbima platform.<br><br>
                            <b>Getting Started:</b><br>
                            <b>What is Kakbima?</b> Kakbima is a cloud-based sales management platform that helps businesses streamline lead generation, track opportunities, manage pipelines, automate workflows, and close deals faster.<br>
                            <b>How do I get started?</b> You can sign up for a free trial, set up your organization profile, add your sales team, and start tracking leads and deals right away.<br><br>
                            ...
                            <b>Can I integrate Kakbima with other tools?</b> Yes, Kakbima integrates with popular CRMs, email marketing platforms, communication apps, and payment gateways.<br><br>
            ...
            [
                'title' => 'Refund Policy',
                'slug' => 'refund-policy',
                'content' => "We value your trust in <b>Kakbima</b> and are committed to delivering the best experience. Please review our refund policy below.<br><br>

                            <b>30-Day Money Back Guarantee:</b> We offer a 30-day money-back guarantee on all premium subscription plans. If Kakbima does not meet your expectations, you can request a full refund within 30 days of purchase.<br><br>
