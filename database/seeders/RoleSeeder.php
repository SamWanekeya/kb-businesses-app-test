...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $adminPermissions = Permission::whereIn('name', [
            ...
            'manage-users-referral-program',
            'manage-setting-referral-program',
            'manage-payout-referral-program',
            'approve-payout-referral-program',
            'reject-payout-referral-program',
