    ...
    return {
        ...
        resolve: {
            alias: {
                ...
                '@utils': resolve(import.meta.dirname, 'resources/js/utils'),
                '@components': resolve(import.meta.dirname, 'resources/js/components'),
                '@config': resolve(import.meta.dirname, 'resources/js/config'),
                '@contexts': resolve(import.meta.dirname, 'resources/js/contexts'),
                '@pages': resolve(import.meta.dirname, 'resources/js/pages'),
                '@hooks': resolve(import.meta.dirname, 'resources/js/hooks'),
                '@layouts': resolve(import.meta.dirname, 'resources/js/layouts'),
                '@lib': resolve(import.meta.dirname, 'resources/js/lib'),
                '@types': resolve(import.meta.dirname, 'resources/js/types'),
                '@lang': resolve(import.meta.dirname, 'resources/lang'),
